    ...
    def load_data(self, path):
        ...
        with open(path, 'r', encoding = 'utf8') as i:
            ...
            for l in lines:
                ...
                text1 = content_list[0]
                text2 = content_list[1]
                target = int(content_list[2])
                seg_text1 = self.tokenizer.tokenize(text1)
                seg_text2 = self.tokenizer.tokenize(text2)
                src_list.append((self.seq_cut(seg_text1), self.seq_cut(seg_text2)))
